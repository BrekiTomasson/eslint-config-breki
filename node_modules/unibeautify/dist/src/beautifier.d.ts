...
export declare class Unibeautify {
    ...
    */
    ...
    private beautifyWithBeautifiers({beautifiers, language, langOptions, fileExtension, projectPath, text});
    /**
...
export declare function optionKeys(beautifier: Beautifier, language: Language): BeautifierOptionName[];
